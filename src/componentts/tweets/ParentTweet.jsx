        ...
        <div className={styles.parent__tweet__container}>
                <div className={styles.tweet__details}>
                    ...
                    <div className={styles.main__tweet__placeholder}>
                        <p>Today</p>
                        <div className={styles.main__tweet__placeholder__tweets}>
...
export default withRouter(connect(mapStateToProps, mapStateToDispatch)(ParentTweet));